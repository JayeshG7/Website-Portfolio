...
export default function StarbucksCaseStudy() {
  const caseStudy = caseStudies.find(cs => cs.slug === 'starbucks-scaling-service')!;
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <MetricCard
            ...
            label={caseStudy.metrics.metric1Label || "YoY Revenue"}
            icon="📈"
          />
          <MetricCard
            value={caseStudy.metrics.metric2}
            label={caseStudy.metrics.metric2Label || "Unique Customers"}
            icon="🎯"
          />
          <MetricCard
