...
export default function EFICaseStudy() {
  const caseStudy = caseStudies.find(cs => cs.slug === 'efi-sales-strategy')!;
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <MetricCard
            ...
            label={caseStudy.metrics.metric1Label || "Sales Growth"}
            icon="📈"
          />
          <MetricCard
            value={caseStudy.metrics.metric2}
            label={caseStudy.metrics.metric2Label || "Direct Sales"}
            icon="🎯"
          />
          <MetricCard
