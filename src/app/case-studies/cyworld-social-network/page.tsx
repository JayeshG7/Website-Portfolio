...
export default function CyworldCaseStudy() {
  const caseStudy = caseStudies.find(cs => cs.slug === 'cyworld-social-network')!;
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <MetricCard
            ...
            label={caseStudy.metrics.metric1Label || "Total Users"}
            icon="📈"
          />
          <MetricCard
            value={caseStudy.metrics.metric2}
            label={caseStudy.metrics.metric2Label || "20s Penetration"}
            icon="🎯"
          />
          <MetricCard
            value={caseStudy.metrics.timeFrame}
            label={caseStudy.metrics.timeFrameLabel || "Period"}
            icon="⏱️"
          />
        </div>
