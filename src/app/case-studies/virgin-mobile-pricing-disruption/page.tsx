...
export default function VirginMobileCaseStudy() {
  const caseStudy = caseStudies.find(cs => cs.slug === 'virgin-mobile-pricing-disruption')!;
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <MetricCard
            ...
            label={caseStudy.metrics.metric1Label || "Retail Locations"}
            icon="📈"
          />
          <MetricCard
            value={caseStudy.metrics.metric2}
            label={caseStudy.metrics.metric2Label || "Target Users"}
            icon="🎯"
          />
          <MetricCard
            value={caseStudy.metrics.timeFrame}
            label={caseStudy.metrics.timeFrameLabel || "Time Frame"}
            icon="⏱️"
          />
        </div>
